...
async function run() {
  ...
  const content = 'Join our SEBI-registered crypto trading group. Members earned 340% returns last month. Minimum investment ₹10,000. Telegram: t.me/IndiaProTraders. Limited slots available today only.';
